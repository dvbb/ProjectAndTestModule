...
namespace Deprecated.Tests.Fluent
{
    internal class SqlTests
    {
        ...
        public async Task Get_Server()
        {
            ...
            string clientId = baseClient.clientId;
            string clientSecret = baseClient.clientSecret;
            string tenantId = baseClient.tenantId;
            string subscription = baseClient.subscription;
